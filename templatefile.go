...
func templatefile(baseDir string, path string, vars string) (string, error) {
	terraformFunctions := map[string]function.Function{
	...
	f := funcs.MakeTemplateFileFunc(baseDir, func() map[string]function.Function {
